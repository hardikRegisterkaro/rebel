      ...
      <div className="mx-auto max-w-(--spacing-shell) px-6 pb-[clamp(64px,10vh,110px)] sm:px-7">
        ...
        >
          {VALUES.map((value) => (
            <li
              key={value.code}
              className="flex min-h-[250px] flex-col gap-3.5 bg-paper px-6.5 py-7.5"
            >
              ...
              <p className="text-[0.88rem] leading-[1.55] text-[#666666]">
                {value.desc}
              </p>
              <p className="mt-auto border-t border-black/10 pt-4 font-mono text-[0.7rem] font-semibold text-light-fg">
                {value.metric}
              </p>
            </li>
          ))}
