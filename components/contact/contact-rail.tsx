    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        <Link href="/careers" className={`flex flex-col gap-2 ${RAIL_CARD}`}>
          ...
          <span className="text-[0.98rem] font-semibold">Join the lab</span>
